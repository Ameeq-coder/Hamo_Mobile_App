...
import 'Bloc/CalendarBookingBloc.dart';
import 'Bloc/CalendarBookingEvent.dart';
import 'Bloc/CalendarBookingState.dart';
...
class _CalendarScreenState extends State<CalendarScreen> {
  ...
  void _fetchBookingsForDate(DateTime date) {
    ...
    BlocProvider.of<CalendarBookingBloc>(context).add(
      CreateCalendarBookingEvent(userId, formattedDate),
    );
  }
  ...
  void _mapToUI(List<CalendarBooking> bookings) {
  ...
  Widget build(BuildContext context) {
    return BlocListener<CalendarBookingBloc, CalendarBookingState>(
      listener: (context, state) {
        if (state is CalendarBookingSuccess) {
          _mapToUI(state.bookings);
        } else if (state is CalendarBookingError) {
          selectedBookings = [];
          setState(() {});
        }
      },
