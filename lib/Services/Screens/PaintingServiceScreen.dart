...
class PaintingServiceListScreen extends StatelessWidget {
  const PaintingServiceListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Painting', style: TextStyle(color: Colors.black)),
        actions: const [
          Padding(
