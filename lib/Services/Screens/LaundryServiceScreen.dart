...
class LaundryServiceListScreen extends StatelessWidget {
  const LaundryServiceListScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Laundry', style: TextStyle(color: Colors.black)),
        actions: const [
          Padding(
