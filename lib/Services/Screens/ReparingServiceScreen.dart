...
class ReparingServiceListScreen extends StatelessWidget {
  const ReparingServiceListScreen({super.key});
    ...
    Widget build(BuildContext context) {
      ...
      return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: const Text('Repairing', style: TextStyle(color: Colors.black)),
          actions: const [
            Padding(
